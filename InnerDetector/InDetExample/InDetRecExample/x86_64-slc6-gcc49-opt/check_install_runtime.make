...
#cmt_local_tagfile_check_install_runtime = $(InDetRecExample_tag)_check_install_runtime.make
...
#cmt_local_tagfile_check_install_runtime = $(InDetRecExample_tag).make
...
#cmt_final_setup_check_install_runtime = $(bin)InDetRecExample_check_install_runtimesetup.make
...
#cmt_final_setup_check_install_runtime = $(bin)InDetRecExamplesetup.make
cmt_local_check_install_runtime_makefile = $(bin)check_install_runtime.make
...
$(check_install_runtimeactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.7.5/AtlasCore/20.7.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share jobOptions.py  ' -installdir=/afs/cern.ch/user/d/dhayakaw/private/OfflineDQ/SCTMonitoring/InstallArea/share -level=
