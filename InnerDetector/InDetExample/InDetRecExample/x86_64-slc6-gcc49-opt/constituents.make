...
#cmt_local_tagfile = $(InDetRecExample_tag).make
cmt_local_tagfile = $(bin)$(InDetRecExample_tag).make
...
check :: $(check_dependencies)  $(check_pre_constituents) $(check_constituents)  $(check_post_constituents)
	$(echo) "check ok."
...
checkclean ::  $(check_constituentsclean)
	$(echo) $(check_constituentsclean)
	$(echo) "checkclean ok."

#	@echo $(check_constituentsclean)
#	@/bin/echo " checkclean ok."
...
cmt_local_tagfile_install_runtime = $(bin)$(InDetRecExample_tag)_install_runtime.make
...
cmt_local_tagfile_install_runtime = $(bin)$(InDetRecExample_tag).make
...
cmt_InDetRecExampleTesting_test_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_InDetRecExampleTesting_test_has_target_tag

cmt_local_tagfile_InDetRecExampleTesting_test = $(bin)$(InDetRecExample_tag)_InDetRecExampleTesting_test.make
cmt_final_setup_InDetRecExampleTesting_test = $(bin)setup_InDetRecExampleTesting_test.make
cmt_local_InDetRecExampleTesting_test_makefile = $(bin)InDetRecExampleTesting_test.make

InDetRecExampleTesting_test_extratags = -tag_add=target_InDetRecExampleTesting_test

else

cmt_local_tagfile_InDetRecExampleTesting_test = $(bin)$(InDetRecExample_tag).make
cmt_final_setup_InDetRecExampleTesting_test = $(bin)setup.make
cmt_local_InDetRecExampleTesting_test_makefile = $(bin)InDetRecExampleTesting_test.make

endif

not_InDetRecExampleTesting_test_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetRecExampleTesting_test_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetRecExampleTesting_testdirs :
	@if test ! -d $(bin)InDetRecExampleTesting_test; then $(mkdir) -p $(bin)InDetRecExampleTesting_test; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetRecExampleTesting_test
else
InDetRecExampleTesting_testdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetRecExampleTesting_test_makefile) : $(InDetRecExampleTesting_test_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExampleTesting_test.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExampleTesting_test_extratags) build constituent_config -out=$(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test
else
$(cmt_local_InDetRecExampleTesting_test_makefile) : $(InDetRecExampleTesting_test_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExampleTesting_test) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExampleTesting_test) ] || \
	  $(not_InDetRecExampleTesting_test_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetRecExampleTesting_test.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExampleTesting_test_extratags) build constituent_config -out=$(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test; \
	  fi
endif
...
$(cmt_local_InDetRecExampleTesting_test_makefile) : $(InDetRecExampleTesting_test_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExampleTesting_test.make"; \
	  $(cmtexe) -f=$(bin)InDetRecExampleTesting_test.in -tag=$(tags) $(InDetRecExampleTesting_test_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test
else
$(cmt_local_InDetRecExampleTesting_test_makefile) : $(InDetRecExampleTesting_test_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetRecExampleTesting_test.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExampleTesting_test) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExampleTesting_test) ] || \
	  $(not_InDetRecExampleTesting_test_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetRecExampleTesting_test_extratags) build constituent_makefile -out=$(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test

InDetRecExampleTesting_test :: $(InDetRecExampleTesting_test_dependencies) $(cmt_local_InDetRecExampleTesting_test_makefile) dirs InDetRecExampleTesting_testdirs
	$(echo) "(constituents.make) Starting InDetRecExampleTesting_test"
	@if test -f $(cmt_local_InDetRecExampleTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_test
	$(echo) "(constituents.make) InDetRecExampleTesting_test done"

clean :: InDetRecExampleTesting_testclean ;

InDetRecExampleTesting_testclean :: $(InDetRecExampleTesting_testclean_dependencies) ##$(cmt_local_InDetRecExampleTesting_test_makefile)
	$(echo) "(constituents.make) Starting InDetRecExampleTesting_testclean"
	@-if test -f $(cmt_local_InDetRecExampleTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_testclean; \
	fi
	$(echo) "(constituents.make) InDetRecExampleTesting_testclean done"
#	@-$(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) InDetRecExampleTesting_testclean

##	  /bin/rm -f $(cmt_local_InDetRecExampleTesting_test_makefile) $(bin)InDetRecExampleTesting_test_dependencies.make

install :: InDetRecExampleTesting_testinstall ;

InDetRecExampleTesting_testinstall :: $(InDetRecExampleTesting_test_dependencies) $(cmt_local_InDetRecExampleTesting_test_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetRecExampleTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetRecExampleTesting_testuninstall

$(foreach d,$(InDetRecExampleTesting_test_dependencies),$(eval $(d)uninstall_dependencies += InDetRecExampleTesting_testuninstall))

InDetRecExampleTesting_testuninstall : $(InDetRecExampleTesting_testuninstall_dependencies) ##$(cmt_local_InDetRecExampleTesting_test_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetRecExampleTesting_test_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExampleTesting_test_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetRecExampleTesting_testuninstall ;
...
cmt_InDetRecExamplerchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_InDetRecExamplerchk_has_target_tag

cmt_local_tagfile_InDetRecExamplerchk = $(bin)$(InDetRecExample_tag)_InDetRecExamplerchk.make
cmt_final_setup_InDetRecExamplerchk = $(bin)setup_InDetRecExamplerchk.make
cmt_local_InDetRecExamplerchk_makefile = $(bin)InDetRecExamplerchk.make

InDetRecExamplerchk_extratags = -tag_add=target_InDetRecExamplerchk

else

cmt_local_tagfile_InDetRecExamplerchk = $(bin)$(InDetRecExample_tag).make
cmt_final_setup_InDetRecExamplerchk = $(bin)setup.make
cmt_local_InDetRecExamplerchk_makefile = $(bin)InDetRecExamplerchk.make

endif

not_InDetRecExamplerchk_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetRecExamplerchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetRecExamplerchkdirs :
	@if test ! -d $(bin)InDetRecExamplerchk; then $(mkdir) -p $(bin)InDetRecExamplerchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetRecExamplerchk
else
InDetRecExamplerchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetRecExamplerchk_makefile) : $(InDetRecExamplerchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExamplerchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExamplerchk_extratags) build constituent_config -out=$(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk
else
$(cmt_local_InDetRecExamplerchk_makefile) : $(InDetRecExamplerchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExamplerchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExamplerchk) ] || \
	  $(not_InDetRecExamplerchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetRecExamplerchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExamplerchk_extratags) build constituent_config -out=$(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk; \
	  fi
endif
...
$(cmt_local_InDetRecExamplerchk_makefile) : $(InDetRecExamplerchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExamplerchk.make"; \
	  $(cmtexe) -f=$(bin)InDetRecExamplerchk.in -tag=$(tags) $(InDetRecExamplerchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk
else
$(cmt_local_InDetRecExamplerchk_makefile) : $(InDetRecExamplerchk_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetRecExamplerchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExamplerchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExamplerchk) ] || \
	  $(not_InDetRecExamplerchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetRecExamplerchk_extratags) build constituent_makefile -out=$(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk

InDetRecExamplerchk :: $(InDetRecExamplerchk_dependencies) $(cmt_local_InDetRecExamplerchk_makefile) dirs InDetRecExamplerchkdirs
	$(echo) "(constituents.make) Starting InDetRecExamplerchk"
	@if test -f $(cmt_local_InDetRecExamplerchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchk
	$(echo) "(constituents.make) InDetRecExamplerchk done"

clean :: InDetRecExamplerchkclean ;

InDetRecExamplerchkclean :: $(InDetRecExamplerchkclean_dependencies) ##$(cmt_local_InDetRecExamplerchk_makefile)
	$(echo) "(constituents.make) Starting InDetRecExamplerchkclean"
	@-if test -f $(cmt_local_InDetRecExamplerchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchkclean; \
	fi
	$(echo) "(constituents.make) InDetRecExamplerchkclean done"
#	@-$(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) InDetRecExamplerchkclean

##	  /bin/rm -f $(cmt_local_InDetRecExamplerchk_makefile) $(bin)InDetRecExamplerchk_dependencies.make

install :: InDetRecExamplerchkinstall ;

InDetRecExamplerchkinstall :: $(InDetRecExamplerchk_dependencies) $(cmt_local_InDetRecExamplerchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetRecExamplerchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetRecExamplerchkuninstall

$(foreach d,$(InDetRecExamplerchk_dependencies),$(eval $(d)uninstall_dependencies += InDetRecExamplerchkuninstall))

InDetRecExamplerchkuninstall : $(InDetRecExamplerchkuninstall_dependencies) ##$(cmt_local_InDetRecExamplerchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetRecExamplerchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExamplerchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetRecExamplerchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetRecExample_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetRecExample_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_myctest = $(bin)$(InDetRecExample_tag)_myctest.make
...
cmt_local_tagfile_myctest = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_make = $(bin)$(InDetRecExample_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetRecExample_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetRecExample_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetRecExample_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetRecExample_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetRecExample_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetRecExample_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetRecExample_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(InDetRecExample_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetRecExample_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetRecExample_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetRecExample_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetRecExample_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetRecExample_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(InDetRecExample_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetRecExample_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(InDetRecExample_tag)_check_install_runtime.make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(InDetRecExample_tag).make
...
InDetRecExample_validateXML_extratags = -tag_add=target_InDetRecExample_validateXML
...
not_InDetRecExample_validateXML_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetRecExample_validateXML_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetRecExample_validateXMLdirs :
	@if test ! -d $(bin)InDetRecExample_validateXML; then $(mkdir) -p $(bin)InDetRecExample_validateXML; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetRecExample_validateXML
else
InDetRecExample_validateXMLdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetRecExample_validateXML_makefile) : $(InDetRecExample_validateXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExample_validateXML.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExample_validateXML_extratags) build constituent_config -out=$(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML
else
$(cmt_local_InDetRecExample_validateXML_makefile) : $(InDetRecExample_validateXML_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExample_validateXML) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExample_validateXML) ] || \
	  $(not_InDetRecExample_validateXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetRecExample_validateXML.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetRecExample_validateXML_extratags) build constituent_config -out=$(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML; \
	  fi
endif
...
$(cmt_local_InDetRecExample_validateXML_makefile) : $(InDetRecExample_validateXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetRecExample_validateXML.make"; \
	  $(cmtexe) -f=$(bin)InDetRecExample_validateXML.in -tag=$(tags) $(InDetRecExample_validateXML_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML
else
$(cmt_local_InDetRecExample_validateXML_makefile) : $(InDetRecExample_validateXML_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetRecExample_validateXML.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetRecExample_validateXML) ] || \
	  [ ! -f $(cmt_final_setup_InDetRecExample_validateXML) ] || \
	  $(not_InDetRecExample_validateXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetRecExample_validateXML_extratags) build constituent_makefile -out=$(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML

InDetRecExample_validateXML :: $(InDetRecExample_validateXML_dependencies) $(cmt_local_InDetRecExample_validateXML_makefile) dirs InDetRecExample_validateXMLdirs
	$(echo) "(constituents.make) Starting InDetRecExample_validateXML"
	@if test -f $(cmt_local_InDetRecExample_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXML
	$(echo) "(constituents.make) InDetRecExample_validateXML done"

clean :: InDetRecExample_validateXMLclean ;

InDetRecExample_validateXMLclean :: $(InDetRecExample_validateXMLclean_dependencies) ##$(cmt_local_InDetRecExample_validateXML_makefile)
	$(echo) "(constituents.make) Starting InDetRecExample_validateXMLclean"
	@-if test -f $(cmt_local_InDetRecExample_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXMLclean; \
	fi
	$(echo) "(constituents.make) InDetRecExample_validateXMLclean done"
#	@-$(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) InDetRecExample_validateXMLclean

##	  /bin/rm -f $(cmt_local_InDetRecExample_validateXML_makefile) $(bin)InDetRecExample_validateXML_dependencies.make

install :: InDetRecExample_validateXMLinstall ;

InDetRecExample_validateXMLinstall :: $(InDetRecExample_validateXML_dependencies) $(cmt_local_InDetRecExample_validateXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetRecExample_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetRecExample_validateXMLuninstall

$(foreach d,$(InDetRecExample_validateXML_dependencies),$(eval $(d)uninstall_dependencies += InDetRecExample_validateXMLuninstall))

InDetRecExample_validateXMLuninstall : $(InDetRecExample_validateXMLuninstall_dependencies) ##$(cmt_local_InDetRecExample_validateXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetRecExample_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetRecExample_validateXML_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetRecExample_validateXMLuninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(InDetRecExample_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_compile = $(bin)$(InDetRecExample_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetRecExample_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetRecExample_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetRecExample_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetRecExample_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetRecExample_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetRecExample_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetRecExample_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetRecExample_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetRecExample_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetRecExample_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetRecExample_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetRecExample_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetRecExample_tag).make
