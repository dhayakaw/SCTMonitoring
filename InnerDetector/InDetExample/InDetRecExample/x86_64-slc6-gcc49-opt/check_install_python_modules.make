...
#cmt_local_tagfile_check_install_python_modules = $(InDetRecExample_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(InDetRecExample_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)InDetRecExample_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)InDetRecExamplesetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.7.5/AtlasCore/20.7.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/afs/cern.ch/user/d/dhayakaw/private/OfflineDQ/SCTMonitoring/InstallArea/python/InDetRecExample -level=
